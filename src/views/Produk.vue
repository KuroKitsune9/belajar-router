        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div v-for="produk in state" :key="produk.id"
                class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <img class="" :src="produk.img_produk" alt="product image" />
                <div class="px-5 pb-5">
                    <h4>{{ produk.nama }}</h4>
                ...
                <h4 class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">lihat</h4>
            </router-link>
                    </div>
